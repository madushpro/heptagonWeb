...
//                 <div
//                   className={`glass-card px-7 py-4 rounded-2xl border-2 border-orange-500/30 backdrop-blur-2xl shadow-xl min-w-[160px] text-center ${theme === "dark" ? "bg-black/80" : "bg-white/90 shadow-2xl shadow-black/5 border-zinc-200"}`}
//                 >
//                   <p className="text-[7px] font-black uppercase tracking-[0.5em] text-orange-500/70 mb-1.5">
//                     Module 0{i + 1}
//                   </p>
//                   <span
//                     className={`text-[14px] font-black uppercase tracking-[0.15em] whitespace-nowrap ${theme === "dark" ? "text-white" : "text-zinc-950"}`}
//                   >
//                     {name}
//                   </span>
//                 </div>
...
const HERO_TAGLINE = "We make it happen.";
...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const textTween = gsap.to(state, {
      count: HERO_TAGLINE.length,
      duration: 2.2,
      ease: "none",
      onUpdate: () => {
        setTypedText(HERO_TAGLINE.slice(0, Math.round(state.count)));
      },
    });
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex flex-col lg:flex-row items-center justify-between  gap-10 md:gap-12 overflow-hidden"
    >
      {/* Video Background */}
      {/* <video
        autoPlay
      ...
      {/* Overlay to darken/lighten based on theme */}
      {/* <div
      ...
      {/* Content */}
      <div className="w-full flex flex-col justify-center z-20 relative ml-20">
        {/* <div className="reveal inline-flex items-center space-x-3 dark:bg-white/5 bg-orange-500/5 border dark:border-white/10 border-orange-500/10 rounded-full px-5 py-2 mb-10 w-fit">
          <div className="w-2 h-2 rounded-full bg-orange-500 animate-pulse shadow-[0_0_10px_#FF6B00]"></div>
          <span className="text-[10px] font-black text-orange-500 uppercase tracking-[0.4em]">
            We make it happen
        ...
        {/* <h1 className="reveal text-5xl sm:text-7xl md:text-8xl lg:text-9xl  mb-8 leading-[0.9] sm:leading-[0.85] tracking-tighter uppercase">
          Design Reality. <br />
          <span className="text-white">Reality.</span>
        </h1> */}

        <h1 className="reveal text-5xl sm:text-7xl md:text-8xl lg:text-9xl  mb-8 leading-[0.9] sm:leading-[0.85] tracking-tighter uppercase flex w-full text-center justify-center flex-col ">
          <span>
            {typedText}
            <span ref={cursorRef} className="inline-block ml-2 text-orange-500">
              |
            </span>
          </span>
          {/* <div className="reveal inline-flex items-center space-x-3 dark:bg-white/5 bg-orange-500/5 border dark:border-white/10 border-orange-500/10 rounded-full px-5 py-2 mb-10 w-fit">
